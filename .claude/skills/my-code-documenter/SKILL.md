---
name: my-code-documenter
description: Document the description, purpose, application and code logic of each types, functions, field, constants, variables for AI/LLMs to use as a reference for enhancements
